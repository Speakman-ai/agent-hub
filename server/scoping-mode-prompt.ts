...
export function buildScopingModePreamble(args: {
  ...
  const lines = [
    ...
    '- **Phase** — a focused run of a feature or module (subgroup within the epic). Every epic has **at least one phase** — even a small epic gets a single phase that its tickets hang off of.',
