...
import createVotingWizardRoutes from './routes/voting-wizard.js';
...
import createPrReviewSessionRoutes from './routes/pr-review-session.js';
...
app.use(createVotingWizardRoutes(routeDeps));
...
app.use(createPrReviewSessionRoutes(routeDeps));
