...
export function buildKickoffPrompt(
  ...
  return [
    ...
    '   - Constraints: `on:` must be `finalize`/`manual`; `timeout_minutes` in `[1, 240]` (pipeline wall-clock hang limit, not the 4-hour active-time budget). Full schema: `references/ci-yaml-schema.md`.',
