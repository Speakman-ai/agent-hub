# EXAMPLE: ALB in one AWS account, public DNS in another (e.g. aimetrics.com).
...
#    of public_fqdn under the zone (e.g. agenthub.ryan) → alias to:
#    outputs.dedicated_alb_dns_name + dedicated_alb_zone_id from this apply.
#
# project_name  = "agenthub"
# public_fqdn   = "agenthub.ryan.aimetrics.com"
# base_domain   = "aimetrics.com" # must match your certificate SAN and logical parent; used in outputs
