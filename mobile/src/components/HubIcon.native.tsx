...
import { Activity, BookOpen, Bot, CalendarDays, ChartColumn, ChevronDown, ChevronRight, Clock, Cloud, GitBranch, GitPullRequest, KeyRound, LayoutGrid, LifeBuoy, Mail, List, ListOrdered, Palette, Play, Plus, ScanEye, Settings, ShieldAlert, Sparkles, StickyNote, Target, } from 'lucide-react-native';
import { colors } from '../theme/colors';
import { HUB_ICON_NAMES } from '../utils/hubIconNames';
import { resolveLucideIconName } from '../utils/hubIconNative';
/** Lucide SVG on native — no icon fonts; works in Expo Go via react-native-svg. */
