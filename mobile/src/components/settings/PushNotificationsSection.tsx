...
export const PUSH_EVENT_OPTIONS = [
  ...
  {
    key: 'review_assigned_to_you',
    label: 'Review assigned to you',
    desc: 'PR or card needs review',
  },
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.hint}>
        Native notifications are limited to projects you own. Toggle which event types can reach
        your device below.
      </Text>
      ...
      {!pushToken ? (
        ...
        <>
          ...
          {PUSH_EVENT_OPTIONS.map((opt: any) => (
