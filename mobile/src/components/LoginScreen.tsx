        ...
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          <View style={styles.card}>
            ...
            {mode !== 'loading' && (<>
                ...
                <TextInput style={styles.textInput} value={username} onChangeText={setUsername} placeholder="owner" placeholderTextColor={colors.gray500} autoCapitalize="none" autoCorrect={false} autoComplete="username" testID="login-username"/>
            ...
            ]} onPress={handleSubmit} disabled={submitting || !username || !password} testID="login-submit">
