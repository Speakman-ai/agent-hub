    ...
    <View style={[styles.questionCard, errored && styles.questionCardErrored]}>
      <View style={styles.questionHeader}>
        <View style={styles.headerBadge}>
          <Text style={styles.headerBadgeText}>{(question.header || '').slice(0, 12)}</Text>
        </View>
...
function OtherRow({ multi, checked, disabled, otherText, onSelect, onTextChange }: any) {
  return (
    <View
      style={[styles.otherRow, checked && styles.otherRowActive, disabled && styles.disabledFaded]}
    >
      <TouchableOpacity
        onPress={onSelect}
        disabled={disabled}
