...
function DelegationPanel({ delegations, onCancel, sessionId }: any) {
  ...
  const allFinished = delegations.every((t: any) =>
          ...
          {delegations.map((task: any, idx: any) => {
            ...
            return (
              <View key={task.delegationId || idx} style={styles.taskRow}>
                ...
                >
                  <View
                    style={[styles.taskDot, { backgroundColor: task.agentColor || colors.gray500 }]}
                  />
                  <Text style={styles.taskAgent} numberOfLines={1}>
