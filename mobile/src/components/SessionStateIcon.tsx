...
export default function SessionStateIcon({ state, size = 14, style, testID = 'session-state-icon' }: any) {
    ...
    return (<AppIcon name={ICONS[meta.icon] || ICONS.MessageCircleQuestion} size={size} color={color} style={style} testID={testID} accessibilityLabel={meta.label}/>);
}
