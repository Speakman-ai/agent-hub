...
function SubagentCard({ use, result }: any) {
    ...
    return (<View style={[styles.container, errored && styles.errored]}>
      ...
      {(model || background || isolation) && (<View style={styles.meta}>
          {model && (<View style={styles.badge}>
              <Text style={styles.badgeText}>
                {model.replace('claude-', '').replace(/-/g, ' ')}
              </Text>
            </View>)}
          {background && (<View style={styles.badge}>
              <Text style={styles.badgeText}>background</Text>
            </View>)}
          {isolation && (<View style={styles.badge}>
              <Text style={styles.badgeText}>{isolation}</Text>
            </View>)}
        </View>)}

      {open && (<View style={styles.body}>
          {input.prompt && (<View style={styles.section}>
          ...
          {result && (<View style={styles.section}>
              ...
              <ScrollView style={[styles.resultBox, errored && styles.resultBoxError]} nestedScrollEnabled>
