...
export default function RunnersScreen({ route, navigation }: any) {
    ...
    return (<SafeAreaView style={styles.screen} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {selectedRun && (<View style={styles.detailCard}>
            ...
            {detailLoading ? (<ActivityIndicator color={colors.gray400}/>) : detail?.error ? (<Text style={styles.error}>{detail.error}</Text>) : (<Text style={styles.detailJson}>
