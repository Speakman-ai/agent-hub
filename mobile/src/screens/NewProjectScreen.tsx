    ...
    return (
      <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
        <View style={styles.successBody}>
          ...
          {createdProject.jobId ? <Text style={styles.jobText}>Job: {createdProject.jobId}</Text> : null}
          ...
          <TouchableOpacity
            style={[styles.primaryButton, (createdProject.loadError || submitting) && styles.disabledButton]}
...
const styles = StyleSheet.create({
  ...
  errorBox: { padding: 12, backgroundColor: colors.red900_50, borderBottomWidth: 1, borderBottomColor: colors.red600 },
  errorText: { color: colors.red400, fontSize: 13 },
  loadErrorBox: { marginTop: 16, padding: 12, borderRadius: 8, borderWidth: 1, borderColor: colors.amber400, backgroundColor: colors.amber900_40 },
  submittingOverlay: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 16, paddingVertical: 8, backgroundColor: colors.gray900 },
  submittingText: { color: colors.gray300, fontSize: 12 },
  successBody: { margin: 16, padding: 20, borderRadius: 12, borderWidth: 1, borderColor: colors.gray800, backgroundColor: colors.gray900 },
  ...
  primaryButton: { alignItems: 'center', paddingVertical: 13, borderRadius: 9, backgroundColor: colors.emerald600, marginTop: 24 },
  retryButton: { alignItems: 'center', paddingVertical: 10, borderRadius: 8, backgroundColor: colors.gray700, marginTop: 10 },
