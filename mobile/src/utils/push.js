 ...
 * @returns {boolean}
 */
export function canReceivePush(Device) {
 ...
 */
export function buildDeviceRegistrationBody(token, platform) {
 ...
 */
export async function presentLocalNotification({ Notifications }, { title, body, data }) {
