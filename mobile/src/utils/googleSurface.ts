/**
 * Shared predicates for Google Workspace surfaces on mobile. Mirrors
...
// Sheets + Drive/Docs scopes. Agent/API Sheets writes need the full
// `spreadsheets` scope. Drive/Docs saves need only the NON-restricted
// `drive.file` scope — never `drive.readonly` or full `drive` (restricted,
