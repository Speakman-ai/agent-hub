...
import { SECRET_MASK, validateSecretKey, buildUpsertSecretsPayload, displaySecretValue, describeSecretsPermissionError, } from './settingsSecrets';
...
describe('buildUpsertSecretsPayload', () => {
    ...
    it('replaces a same-key row instead of duplicating it', () => {
        ...
        expect(payload.filter((r: any) => r.key === 'A')).toEqual([{ key: 'A', value: 'new', kind: 'plain' }]);
