 ...
 */
export function providerKeyConfigured(provider, body) {
 ...
 */
export function providerStatusLabel(provider, body) {
 ...
 */
export function buildPutMyAuthBody(provider, key) {
...
export function githubStatusLabel(status) {
