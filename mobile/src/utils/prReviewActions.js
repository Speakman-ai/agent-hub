...
export function reviewStateForEvent(event) {
  const found = REVIEW_EVENTS.find((e) => e.event === event);
 ...
 * @param {string} [body]
 */
export function buildReviewPayload(event, body = '') {
...
export function buildInlineCommentPayload({ filePath, line, side, body } = {}) {
 ...
 */
export function prDetailCapabilities(detail) {
