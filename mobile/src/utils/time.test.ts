...
import { relativeTime, formatElapsed, relativeFuture, daysUntilPurge, parseDate, shortDate, } from './time';
describe('parseDate', () => {
...
describe('daysUntilPurge', () => {
    ...
    it('uses "<1h" when well under an hour remains', () => {
        const deletedAt = new Date(new Date('2026-04-18T12:00:00Z').getTime() -
            (6 * 24 * 60 * 60 * 1000 + 23 * 60 * 60 * 1000 + 59 * 60 * 1000 + 30 * 1000)).toISOString();
