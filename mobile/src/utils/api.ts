...
export const api = {
  ...
  createSession: (agentId: any, name: any, options: any = {}) =>
  ...
  cloneProject: (data: { url: string; targetDir?: string }) =>
    fetchJSON('/projects/clone', {
      method: 'POST',
      body: JSON.stringify(data),
    }),
  analyzeProject: (data: { cwd: string; engine?: string; model?: string }) =>
    fetchJSON('/projects/analyze', {
      method: 'POST',
      body: JSON.stringify(data),
    }),
  onboardProject: (data: Record<string, unknown>) =>
    fetchJSON('/projects/onboard', {
      method: 'POST',
      body: JSON.stringify(data),
    }),
  getGithubCliStatus: () => fetchJSON('/github/status'),
  detectGithubRepo: (cwd: string) =>
    fetchJSON('/github/detect-repo', {
      method: 'POST',
      body: JSON.stringify({ cwd }),
    }),
  testGithubConnection: (owner: string, repo: string) =>
    fetchJSON('/github/test-connection', {
      method: 'POST',
      body: JSON.stringify({ owner, repo }),
    }),
  suggestProjectSetup: (data: any) =>
    fetchJSON('/projects/provision/suggest', { method: 'POST', body: JSON.stringify(data) }),
  provisionProject: (data: any) =>
    fetchJSON('/projects/provision', { method: 'POST', body: JSON.stringify(data) }),
  ...
  resetReleaseNotificationSettings: (projectId: any) =>
    fetchJSON(`/projects/${projectId}/release-notification-settings/reset`, {
      method: 'POST',
    }),
  ...
  updateReleaseDigestRecipient: (projectId: any, recipientId: any, data: any) =>
    fetchJSON(
      `/projects/${projectId}/release-notification-settings/recipients/${encodeURIComponent(recipientId)}`,
      {
        method: 'PATCH',
        body: JSON.stringify(data),
      },
  ...
  getInfraSpend: (projectId: any, params: Record<string, any> = {}) =>
    fetchJSON(`/projects/${projectId}/infra/spend${infraQuery(params)}`),
  getInfraQuotas: (projectId: any, params: Record<string, any> = {}) =>
    fetchJSON(`/projects/${projectId}/infra/quotas${infraQuery(params)}`),
  ...
  getInfraHealthEvents: (projectId: any, params: Record<string, any> = {}) =>
    fetchJSON(`/projects/${projectId}/infra/health-events${infraQuery(params)}`),
  ...
  createInfraHealthIngestToken: (projectId: any) =>
    fetchJSON(`/projects/${projectId}/infra/health-ingest`, { method: 'POST' }),
  revokeInfraHealthIngestToken: (projectId: any) =>
    fetchJSON(`/projects/${projectId}/infra/health-ingest`, { method: 'DELETE' }),
  ...
  updateInfraSpendConfig: (projectId: any, data: { enabled: boolean }) =>
    fetchJSON(`/projects/${projectId}/infra/spend/config`, {
      method: 'PUT',
      body: JSON.stringify(data),
    }),
  ...
  getInfraMonitoringStatus: (projectId: any) =>
    fetchJSON(`/projects/${projectId}/infra/monitoring-status`),
  listInfraResources: (projectId: any, params: Record<string, any> = {}) =>
    fetchJSON(`/projects/${projectId}/infra/resources${infraQuery(params)}`),
  listInfraMetricSeries: (projectId: any, resourceKey: any) =>
    fetchJSON(`/projects/${projectId}/infra/metric-series${infraQuery({ resource: resourceKey })}`),
  getInfraMetricRange: (projectId: any, params: Record<string, any>) =>
    fetchJSON(`/projects/${projectId}/infra/metrics${infraQuery(params)}`),
  listInfraAlertRules: (projectId: any, params: Record<string, any> = {}) =>
    fetchJSON(`/projects/${projectId}/infra/alert-rules${infraQuery(params)}`),
  listInfraAlerts: (projectId: any, params: Record<string, any> = {}) =>
    fetchJSON(`/projects/${projectId}/infra/alerts${infraQuery(params)}`),
  getInfraAlert: (projectId: any, alertId: any) =>
    fetchJSON(`/projects/${projectId}/infra/alerts/${encodeURIComponent(alertId)}`),
  // `resolved` closes it out, `ignored` mutes it through recurrence, `open`
  // reopens it. There is no separate reopen verb.
  setInfraAlertStatus: (projectId: any, alertId: any, status: any) =>
    fetchJSON(`/projects/${projectId}/infra/alerts/${encodeURIComponent(alertId)}/status`, {
      method: 'PUT',
  ...
  startInfraWizard: (projectId: any) =>
    fetchJSON(`/projects/${projectId}/infra/setup-wizard`, {
      method: 'POST',
      body: JSON.stringify({}),
    }),
  ...
  setReplayRetention: (replayId: any, extend: boolean) =>
    fetchJSON(`/replays/${encodeURIComponent(replayId)}/retention`, {
      method: 'POST',
  ...
  listDeployTriggers: (projectId: any, environmentName: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/triggers`,
    ),
  createDeployTrigger: (projectId: any, environmentName: any, body: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/triggers`,
      {
        method: 'POST',
  ...
  updateDeployTrigger: (projectId: any, environmentName: any, triggerId: any, body: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/triggers/${triggerId}`,
      {
        method: 'PATCH',
        body: JSON.stringify(body),
      },
    ),
  deleteDeployTrigger: (projectId: any, environmentName: any, triggerId: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/triggers/${triggerId}`,
      {
        method: 'DELETE',
  ...
  listDeploySchedules: (projectId: any, environmentName: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/schedules`,
    ),
  createDeploySchedule: (projectId: any, environmentName: any, body: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/schedules`,
      {
        method: 'POST',
  ...
  updateDeploySchedule: (projectId: any, environmentName: any, scheduleId: any, body: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/schedules/${scheduleId}`,
      {
        method: 'PATCH',
        body: JSON.stringify(body),
      },
    ),
  deleteDeploySchedule: (projectId: any, environmentName: any, scheduleId: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/schedules/${scheduleId}`,
      {
        method: 'DELETE',
  ...
  listDeployReleaseGates: (projectId: any, environmentName: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/release-gates`,
    ),
  createDeployReleaseGate: (projectId: any, environmentName: any, body: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/release-gates`,
      {
        method: 'POST',
  ...
  updateDeployReleaseGate: (projectId: any, environmentName: any, gateId: any, body: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/release-gates/${gateId}`,
      {
        method: 'PATCH',
        body: JSON.stringify(body),
      },
    ),
  deleteDeployReleaseGate: (projectId: any, environmentName: any, gateId: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/release-gates/${gateId}`,
      {
        method: 'DELETE',
  ...
  getNotificationRouting: (projectId: any, environmentName: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/notification-routing`,
    ),
  updateNotificationRouting: (projectId: any, environmentName: any, body: any) =>
    fetchJSON(
      `/projects/${projectId}/deploy/environments/${encodeURIComponent(environmentName)}/notification-routing`,
      {
        method: 'PUT',
  ...
  retryReleaseNotification: (projectId: any, deploymentId: any, notificationId: any) =>
    fetchJSON(
      `/projects/${projectId}/deployments/${deploymentId}/release-notifications/${encodeURIComponent(notificationId)}/retry`,
      {
        method: 'POST',
        body: JSON.stringify({}),
      },
  ...
  deleteProjectSecret: (projectId: any, key: any) =>
    fetchJSON(`/projects/${projectId}/secrets/${encodeURIComponent(key)}`, {
      method: 'DELETE',
    }),
  importProjectSecrets: (projectId: any, data: any) =>
  ...
  putMyAuth: (provider: any, data: any) =>
  ...
  startMyCursorBrowserLogin: () =>
    fetchJSON('/auth/me/cursor-auth/browser/login', { method: 'POST', body: JSON.stringify({}) }),
  ...
  listTodos: (status?: 'open' | 'done') =>
    fetchJSON(`/me/todos${status ? `?status=${status}` : ''}`),
  createTodo: (data: any) => fetchJSON('/me/todos', { method: 'POST', body: JSON.stringify(data) }),
  updateTodo: (id: any, data: any) =>
    fetchJSON(`/me/todos/${encodeURIComponent(id)}`, { method: 'PUT', body: JSON.stringify(data) }),
  ...
  linkTodo: (
    id: any,
    data: { targetType: 'card' | 'epic' | 'session'; targetId: string; projectId?: string },
  ) =>
    fetchJSON(`/me/todos/${encodeURIComponent(id)}/link`, {
      method: 'POST',
      body: JSON.stringify(data),
    }),
  unlinkTodo: (id: any) =>
    fetchJSON(`/me/todos/${encodeURIComponent(id)}/link`, { method: 'DELETE' }),
  ...
  promoteTodo: (
    id: any,
    data: { projectId: string; columnId?: string; epicId?: string; priority?: string },
  ) =>
    fetchJSON(`/me/todos/${encodeURIComponent(id)}/promote`, {
      method: 'POST',
      body: JSON.stringify(data),
    }),
  getLinkedTodos: (target: {
    targetType: 'card' | 'epic' | 'session';
    targetId: string;
    projectId?: string;
  }) => {
    const params = new URLSearchParams({
  ...
  createGoogleCalendarEvent: (data: any) =>
    fetchJSON('/google/calendar/events', {
      method: 'POST',
      body: JSON.stringify(data),
    }),
  ...
  sendGoogleGmailMessage: (data: any) =>
    fetchJSON('/google/gmail/messages', {
      method: 'POST',
      body: JSON.stringify(data),
    }),
  ...
  readGoogleSheetValues: (
    spreadsheetId: any,
    { range, majorDimension, valueRenderOption, dateTimeRenderOption }: any,
  ) => {
    const params = new URLSearchParams();
  ...
  putMyAgentEngineOverride: (agentId: any, data: any) =>
  ...
  putMyAgentModelOverride: (agentId: any, data: any) =>
  ...
  registerDevice: (token: any, platform: any = 'ios') =>
    fetchJSON('/devices', {
      method: 'POST',
  ...
  getLatestFinalizeRunForSession: (sessionId: any) =>
    fetchJSON(`/sessions/${sessionId}/finalize-runs/latest?includeStale=0`),
  getSessionWorktreeChanges: (sessionId: any) =>
  ...
  startFinalizeRun: (projectId: any, cardId: any) =>
    fetchJSON(`/projects/${projectId}/cards/${cardId}/finalize`, {
      method: 'POST',
      body: JSON.stringify({}),
    }),
  startFinalizeRunForSession: (projectId: any, sessionId: any) =>
  ...
  getReviewerThreads: (projectId: any, runId: any) =>
  ...
  createKanbanColumn: (projectId: any, data: any) =>
    fetchJSON(`/projects/${projectId}/board/columns`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(data),
    }),
  updateKanbanColumn: (projectId: any, columnId: any, data: any) =>
    fetchJSON(`/projects/${projectId}/board/columns/${columnId}`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(data),
    }),
  deleteKanbanColumn: (projectId: any, columnId: any) =>
    fetchJSON(`/projects/${projectId}/board/columns/${columnId}`, {
      method: 'DELETE',
    }),
  createKanbanCard: (projectId: any, data: any) =>
    fetchJSON(`/projects/${projectId}/board/cards`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(data),
    }),
  updateKanbanCard: (projectId: any, cardId: any, data: any) =>
    fetchJSON(`/projects/${projectId}/board/cards/${cardId}`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(data),
    }),
  moveKanbanCard: (projectId: any, cardId: any, data: any) =>
    fetchJSON(`/projects/${projectId}/board/cards/${cardId}/move`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(data),
    }),
  deleteKanbanCard: (projectId: any, cardId: any) =>
  ...
  clearEpicStartSchedule: (projectId: any, epicId: any) =>
    fetchJSON(`/projects/${projectId}/board/epics/${epicId}/start-schedule`, { method: 'DELETE' }),
  ...
  createPull: (projectId: any, data: any) =>
    fetchJSON(`/projects/${projectId}/pulls`, { method: 'POST', body: JSON.stringify(data) }),
  updatePull: (projectId: any, number: any, data: any) =>
    fetchJSON(`/projects/${projectId}/pulls/${number}`, {
      method: 'PATCH',
      body: JSON.stringify(data),
    }),
  reopenPull: (projectId: any, number: any) =>
    fetchJSON(`/projects/${projectId}/pulls/${number}/reopen`, {
      method: 'POST',
      body: JSON.stringify({}),
    }),
  // Arm/disarm native PR auto-merge. Returns { pr, merged }.
  setPullAutoMerge: (projectId: any, number: any, enabled: boolean) =>
  ...
  revertPull: (projectId: any, number: any) =>
    fetchJSON(`/projects/${projectId}/pulls/${number}/revert`, {
      method: 'POST',
      body: JSON.stringify({}),
    }),
  ...
  setPullCommentThreadResolved: (projectId: any, number: any, data: any) =>
  ...
  getNotes: (projectId: any, query?: any, limit?: any) =>
    fetchJSON(buildNotesListUrl(projectId, query, limit)),
  ...
  retryJob: (id: any) =>
    fetchJSON(`/jobs/${id}/retry`, { method: 'POST', body: JSON.stringify({}) }),
  ...
  registerDeviceToken: (token: any, platform: any) =>
    fetchJSON('/devices', {
      method: 'POST',
      body: JSON.stringify({ token, platform }),
    }),
  unregisterDeviceToken: (token: any) =>
  ...
  setDeviceTokenPreferences: (token: any, enabledEvents: any) =>
