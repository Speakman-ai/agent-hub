 ...
 * Matches the primary engine picker on web TopBar (no gemini-cli row).
 */
export const AUTH_MODEL_ENGINE_ORDER = ['claude-code', 'cursor-agent', 'codex-cli'];
export function firstEngineWithAuthenticatedModels(modelConfig: any) {
...
export function defaultModelForAuthenticatedEngine(modelConfig: any, engine: any) {
