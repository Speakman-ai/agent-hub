 ...
 */
export function mapRowsFromMessageEventsApi(data) {
  return (data || []).map((e) => ({
    seq: e.seq,
...
export function notifyParentOfLoadedEvents(onEventsLoaded, messageId, data) {
 ...
 */
export function applyLazyMessageEventsResult({ cancelled, ok, data, messageId, onEventsLoaded }) {
