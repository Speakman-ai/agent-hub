...
/**
 * Return the full open-list id order after moving `id` one slot inside its
...
/**
 * Convert a date-picker value (YYYY-MM-DD, or '') into the ISO string we store,
...
/**
 * Edit/create patch for the do-date picker. Always clears deprecated dueAt so
