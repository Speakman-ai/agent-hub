...
import { resolveDesignRedirect, isDesignMigrated } from './designRedirect.js';

describe('resolveDesignRedirect', () => {
  ...
  it('trims whitespace from the recorded session id', () => {
