 ...
 */
export function applyAwaitingInputSnapshot(items: any) {
 ...
 */
export function applyAwaitingInputEvent(prev: any, event: any) {
  ...
  if (event.waiting) {
    ...
    if (
      ...
      existing.askIds.every((id: any, i: any) => id === askIds[i])
    ) {
      return prev;
    }
    return {
 ...
 */
export function clearAwaitingInputForSession(prev: any, sessionId: any) {
 ...
 */
export function shouldNotifyForAwaitingInput({ wasWaiting, sessionId, activeSessionId }: any) {
