...
function isServerHostedPathname(pathname: any) {
  return SERVER_PATH_PREFIXES.some((p: any) => pathname.startsWith(p));
}
 ...
 */
export function resolveServerMediaUrl(raw: any, opts: any = {}) {
