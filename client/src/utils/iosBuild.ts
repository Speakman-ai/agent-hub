 ...
 */
export function buildArtifactGroups(artifacts: any) {
  return {
    ipas: artifacts.filter((a: any) => a.type === 'ipa'),
    recordings: artifacts.filter((a: any) => a.type === 'simulator_recording'),
    screenshots: artifacts.filter((a: any) => a.type === 'screenshot'),
    logs: artifacts.filter((a: any) => a.type === 'log'),
  };
}
 ...
 */
export function formatBuildDuration(seconds: any) {
 ...
 */
export function isBuildActive(status: any) {
 ...
 */
export function getBuildStepDescription(status: any) {
  const steps = {
