...
export function getDefaultShortcuts(isElectron: any = false) {
...
export function getPlatform(nav: any = typeof navigator !== 'undefined' ? navigator : null) {
  if (!nav) return 'other';
...
export function parseBinding(binding: any) {
...
export function hasPrimaryModifier(binding: any) {
...
export function matchShortcut(event: any, binding: any, platform: any = getPlatform()) {
  const parsed = typeof binding === 'string' ? parseBinding(binding) : binding;
...
function displayToken(token: any, platform: any) {
...
export function formatShortcut(binding: any, platform: any = getPlatform()) {
