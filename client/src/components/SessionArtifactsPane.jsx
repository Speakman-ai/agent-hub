...
import { viewArtifact, downloadArtifact } from '../utils/artifactContent.js';
import { formatBytes, isInlineViewable, artifactGlyph } from '../utils/artifactView.js';
 ...
 */
export default function SessionArtifactsPane({ sessionId, reloadToken = 0, onClose, onCount }) {
