...
import { formatCaptureSize, buildUploadsUrl } from '../utils/capture';
import {
  Smartphone,
  Play,
  X,
...
function IosBuildStatusBadge({ status }: any) {
...
function IosBuildLogViewer({ projectId, buildId, onClose }: any) {
...
export function CreateIosBuildModal({ projectId, onClose, onCreated }: any) {
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="number"
                value={prNumber}
                onChange={(e: any) => setPrNumber(e.target.value)}
                placeholder="123"
                required
          ...
          <div>
            ...
            <input
              type="url"
              value={prUrl}
              onChange={(e: any) => setPrUrl(e.target.value)}
...
function ArtifactGallery({ projectId, buildId }: any) {
...
export default function IosBuildCard({ build, projectId, onAction }: any) {
    ...
    <div className={`${config.bg} ${config.border} border rounded-xl p-4`}>
      ...
      <div className="flex items-start justify-between mb-2">
        ...
        <div className="flex items-center gap-1">
          ...
          {/* Artifacts toggle */}
          <button
            onClick={() => setShowArtifacts((prev: any) => !prev)}
