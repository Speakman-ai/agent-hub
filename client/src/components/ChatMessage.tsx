...
} from '../utils/finalizeTimeline';
import FinalizeRunStartedBlock from './finalize/blocks/FinalizeRunStartedBlock';
import FinalizeRebaseBlock from './finalize/blocks/FinalizeRebaseBlock';
...
function isVideoAttachment(att: any) {
...
function isImageLikeAttachment(att: any) {
...
function VideoLightbox({ src, onClose }: any) {
  return (
    <div
...
function MessageAttachments({ attachments }: any) {
  ...
  const openLightbox = (src: any, type: any) => {
    setLightboxSrc(src);
...
function SystemPrFailedMessage({ message }: any) {
