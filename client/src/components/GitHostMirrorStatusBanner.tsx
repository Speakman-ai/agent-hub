...
import { describeMirrorState } from '../utils/mirrorStatus';
...
export default function GitHostMirrorStatusBanner({ projectId, onToast }: any) {
  ...
  const reconcile = async () => {
    ...
    try {
      ...
      setMirror((prev: any) => ({ ...(prev || {}), state: result.state }));
      if (onToast) {
        const msg =
