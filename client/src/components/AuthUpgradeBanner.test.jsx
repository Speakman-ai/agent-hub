...
import { getAuthStatus, setToken } from '../utils/auth.js';
import { getConnectionConfig } from '../utils/connection.js';
...
describe('AuthUpgradeBanner', () => {
  ...
  it('hides itself when the user dismisses the banner', async () => {
    getAuthStatus.mockResolvedValue({ needsMigration: true });
    render(<AuthUpgradeBanner />);
