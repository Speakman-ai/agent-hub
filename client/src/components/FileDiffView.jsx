...
import { splitUnifiedDiff, annotateDiffLines } from '../utils/commitDiff.js';
...
function InlineComposer({ onSubmit, onCancel }) {
...
export function FileDiffSection({
  ...
  const commentsAt = (anchor) =>
    anchor ? comments.filter((c) => c.side === anchor.side && Number(c.line) === anchor.line) : [];
