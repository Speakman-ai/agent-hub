...
export function epicToAutonomousForm(epic) {
  return {
...
export default function EpicAutonomousPanel({ form, onChange, modelConfig }) {
  return (
    <div className="space-y-5" data-testid="epic-autonomous-panel">
      <div className="flex items-center justify-between gap-3 rounded-xl border border-white/[0.08] bg-white/[0.02] p-4">
        ...
        <ToggleSwitch
          ...
          onChange={(on) => onChange({ autonomous: on ? 1 : 0 })}
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => onChange({ pr_base_branch: e.target.value })}
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => onChange({ autonomous_model: e.target.value })}
          ...
          <div className="flex items-start justify-between gap-3 rounded-xl border border-white/[0.08] bg-white/[0.02] p-4">
            ...
            <ToggleSwitch
              ...
              onChange={(on) => onChange({ autonomous_send_it: on ? 1 : 0 })}
            />
          </div>
        </div>
      ) : (
