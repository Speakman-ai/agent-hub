...
import ChangesReadyBox from './ChangesReadyBox';
...
describe('ChangesReadyBox', () => {
  ...
  it('calls onTrigger with sessionId when clicked', async () => {
    ...
    fireEvent.click(screen.getByTestId('create-ticket-pr-button' as any) as any);
    await waitFor(() => {
  ...
  it('calls onDismiss when dismiss control is clicked', () => {
    ...
    fireEvent.click(screen.getByTestId('create-ticket-pr-dismiss' as any) as any);
