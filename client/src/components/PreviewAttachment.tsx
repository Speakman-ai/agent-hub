 ...
 * teach-moment card.
 */
export default function PreviewAttachment({ event, onRetry, onTouch, onConfigure, onSkip }: any) {
...
function PreviewUnavailable({ event, onConfigure, onSkip }: any) {
...
function PreviewFailed({ event, onRetry }: any) {
