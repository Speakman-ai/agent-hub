...
import ForwardDesignModal, { filterDesignForwardTargets } from './ForwardDesignModal';
...
describe('<ForwardDesignModal />', () => {
  ...
  it('submits with selected agent and optional flags', async () => {
    ...
    fireEvent.click(screen.getByText('Dev' as any) as any);
    fireEvent.click(screen.getByLabelText(/include design chat transcript/i as any) as any);
