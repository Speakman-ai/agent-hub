...
function phase(id: any, status: any, at: any = '2026-04-23T00:00:00Z', extra: any = {}) {
  return { type: 'phase', phase: id, status, at, ...extra };
}
function log(line: any, at: any = '2026-04-23T00:00:00Z') {
...
describe('ProvisioningStatus', () => {
  ...
  describe('log tail', () => {
    ...
    it('collapses when toggled and hides the body', () => {
      ...
      fireEvent.click(screen.getByTestId('ps-log-toggle' as any) as any);
  ...
  describe('phase order and gh gating', () => {
    it('renders phases in the canonical order', () => {
      ...
      const ids = Array.from(list).map((el: any) => el.getAttribute('data-testid'));
