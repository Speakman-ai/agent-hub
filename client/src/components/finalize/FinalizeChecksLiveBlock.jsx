...
import { useFinalizeRun, isFinalizeInFlight } from '../../hooks/useFinalizeRun.js';
import FinalizeStepLogModal from './FinalizeStepLogModal.jsx';
import { FinalizeChecksStepList } from './blocks/FinalizeChecksStepList.jsx';
 ...
 */
export default function FinalizeChecksLiveBlock({ sessionId, projectId }) {
