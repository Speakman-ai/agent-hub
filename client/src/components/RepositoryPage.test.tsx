...
describe('RepositoryPage', () => {
  ...
  it('switches branches via the selector', async () => {
    (api.getGitHostCommits as any).mockResolvedValueOnce(mainCommits).mockResolvedValueOnce({
    ...
    fireEvent.change(screen.getByTestId('repo-branch-select' as any), {
  ...
  it('branches tab lists ahead/behind and the default badge', async () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: /Branches/ } as any) as any);
