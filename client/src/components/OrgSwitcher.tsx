...
import { getOrgs, getActiveOrg, switchOrg } from '../utils/orgs';
import { reloadForOrgSwitch } from '../utils/connection';

export default function OrgSwitcher({ onNavigateSettings }: any) {
